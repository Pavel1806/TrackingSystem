...
namespace TrackingSystem.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IServices<ProjectTaskDTO>, ProjectTaskServices>();
            services.AddScoped<IServices<ProjectDTO>, ProjectServices>();
            services.AddScoped<IServices<UserDTO>, UserServices>();
        }
